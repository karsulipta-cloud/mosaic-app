...
const NEED_TAGLINES = {
  ...
  allergen_labeling: 'Undisclosed allergens erode trust & repeat purchase',
...
function renderKPIs() {
  ...
  const kpis = [
    ...
    { label: 'Most Exposed Brand', value: brandExposure[0].brand, sub: `${brandExposure[0].needMentions} need mentions`, cls: '' },
  ];
